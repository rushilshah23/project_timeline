...
void main() async {
  final dynamicTranslate = DynamicTranslate()
    ..translateFunction = getTranslatedValue;
...
class DynamicTranslate {
  Future<dynamic> Function(dynamic arg) translateFunction;
}

Future<dynamic> getTranslatedValue(dynamic data) async {
  var translatedOutput;

  print("getTranslatedValue " +
      data.toString() +
      "  runtype " +
...
Future getMapTranslated(Map data) async {
  ...
  data.forEach((key, value) async {
    ...
    print(
        "subOutput===" + subOutput.toString() + " for key= " + key.toString());
...
Future getListTranslated(List data) async {
